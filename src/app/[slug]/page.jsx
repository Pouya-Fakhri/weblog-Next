...
export default function BlogPage({ params }) {
  ...
  const [commentDisplay, setCommentDisplay] = React.useState(true);
  ...
  return (
    <div className="  px-6 py-3 flex flex-col min-h-screen justify-between ">
      ...
      <div className="postContainer flex justify-around ">
        {blog.posts.map((item) => {
          return (
            <div className=" border rounded-2xl w-1/3 border-[#4F98CA] flex flex-col justify-between gap-1.5 p-1.5 h-[285px] overflow-y-scroll no-scrollbar  ">
                ...
                return (
                  <div
                    className={`${
                      commentDisplay
                        ? "hidden"
                        : "comments border border-[#50D890] p-1 mt-1.5 flex flex-col rounded-[10px]"
                    } `}
                  >
